...
INSERT INTO `bztbl_riders` (`Id`, `FirstName`, `LastName`, `Email`, `Password`, `Address1`, `Address2`, `Phone`, `DeviceId`, `DeviceType`, `isLicenseAccepted`, `isActive`, `CardType`, `CardProvider`, `CardToken`, `CreatedByDate`) VALUES
...
CREATE TABLE IF NOT EXISTS `bztbl_userbankdetails` (
  `Id` int(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bztbl_userbankdetails` (`Id`, `userid`, `Type`, `BankName`, `AccountNumber`, `AccountHoldername`, `RoutingNumber`, `CreatedByDate`) VALUES
